...
from basis import test_plot_vector_corr
...
#D = PerturbedFourxDynamic(prec=prec, c='0.01', j = 16)
...
P = assemble(D, coarsePartition, basis='C2spline_pointwise_preserve_integral_finer_derivatives', epsilon=epsilon, prec=prec, n_jobs=1)
