...
def create_log_deriv_singularities_info(D):
    return [
        ObsSingularity(D._sing1,
                       lambda p: D.bound_int_p_sing1_log_f1_prime(p),
                       lambda q: D.bound_int_sing1_q_log_f1_prime(q) ),
        ObsSingularity(D._real_fence,
                       lambda p: D.bound_int_p_fence_log_f1_prime(p),
                       lambda q: D.bound_int_fence_q_log_f2_prime(q) )
    ]

def compute_lyapunov(D, K, Kcoarse, num_iter, coarse_noise_abs, Kest, shift=0, mod1=False):
    dir = D.name + '_results'
...
D = BZModel(256)
#params = [
#   (D, 2**20, 2**15, 60, 346, 2**13), #0.01052
#]
params = [
    (D, 2**27, 2**18, 60, 4*690, 2**14), #0.01052
     (D, 2**27, 2**18, 60, 4*630, 2**14),
     (D, 2**27, 2**18, 60, 4*578, 2**14),
    (D, 2**27, 2**18, 60, 4*530, 2**14), #0.008087
     (D, 2**27, 2**18, 60, 4*486, 2**14),
     (D, 2**27, 2**18, 60, 4*446, 2**14),
    (D, 2**27, 2**18, 60, 4*408, 2**14), #0.006225
     (D, 2**27, 2**18, 60, 4*374, 2**14),
     (D, 2**27, 2**18, 60, 4*342, 2**14),
    (D, 2**27, 2**18, 60, 4*314, 2**14), #0.004791
     (D, 2**27, 2**18, 60, 4*288, 2**14),
     (D, 2**27, 2**18, 60, 4*264, 2**14),
    (D, 2**27, 2**18, 60, 4*242, 2**14), #0.003692
     (D, 2**27, 2**18, 60, 4*222, 2**14),
     (D, 2**27, 2**18, 60, 4*202, 2**14),
    (D, 2**27, 2**18, 60, 4*186, 2**14), #0.002838
     (D, 2**27, 2**18, 60, 4*170, 2**14),
     (D, 2**27, 2**18, 60, 4*154, 2**14),
    (D, 2**27, 2**18, 60, 4*142, 2**14), #0.002166
     (D, 2**27, 2**18, 60, 4*130, 2**14),
     (D, 2**27, 2**18, 60, 4*120, 2**14),
    (D, 2**27, 2**18, 60, 4*110, 2**14), #0.001678
     (D, 2**27, 2**18, 60, 2*200, 2**14),
     (D, 2**27, 2**18, 60, 2*184, 2**14),
    (D, 2**27, 2**18, 60, 2*168, 2**14), #0.001281
     (D, 2**27, 2**18, 60, 2*154, 2**14),
     (D, 2**27, 2**18, 60, 2*142, 2**14),
    (D, 2**27, 2**18, 60, 2*130, 2**14), #0.0009918
     (D, 2**27, 2**18, 60, 2*120, 2**14),
     (D, 2**27, 2**18, 60, 2*110, 2**14),
    (D, 2**27, 2**18, 60, 2*100, 2**14), #0.0007629
     (D, 2**27, 2**19, 60, 2*184, 2**15),
     (D, 2**27, 2**19, 60, 2*168, 2**15),
    (D, 2**27, 2**19, 60, 2*154, 2**15), #0.0005874
     (D, 2**27, 2**19, 60, 2*140, 2**15),
     (D, 2**27, 2**19, 60, 2*128, 2**15),
    (D, 2**27, 2**19, 60, 2*118, 2**15), #0.0004501
     (D, 2**27, 2**20, 65, 2*220,  2**16),
     (D, 2**27, 2**20, 65, 2*200,  2**16),
    (D, 2**27, 2**20, 70, 2*184,  2**16),  #0.0003509
     (D, 2**27, 2**20, 70, 2*166,  2**16),
     (D, 2**27, 2**20, 70, 2*152,  2**16),
    (D, 2**27, 2**20, 70, 2*140,  2**16),  #0.0002670
     (D, 2**27, 2**20, 70, 2*128,  2**16),
     (D, 2**27, 2**20, 70, 2*118,  2**16),
    (D, 2**27, 2**20, 70, 2*108,  2**16),  #0.0002060
     (D, 2**27, 2**21, 75, 2*198,  2**17),
     (D, 2**27, 2**21, 75, 2*182,  2**17),
    (D, 2**27, 2**21, 75, 2*166,  2**17),  #0.0001583
     (D, 2**27, 2**21, 70, 2*136,  2**17),  #0.0001296
     (D, 2**27, 2**21, 70, 2*112,  2**17),  #0.0001068
]

#params = [
#    (D, 2**25, 2**18, 60, 154, 2**15), #0.0005874
