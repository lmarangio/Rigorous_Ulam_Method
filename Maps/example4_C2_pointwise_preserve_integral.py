...
from quintic_basis import test_plot_vector_corr
...
D = PerturbedFourxDynamic(prec=prec, c='0.02', j = 8)
#D=FourxDynamic()
...
P = assemble(D, coarsePartition, basis='C2spline_pointwise_preserve_integral', epsilon=epsilon, prec=prec, n_jobs=1)
