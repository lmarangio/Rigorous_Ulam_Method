...
D = PerturbedFourxDynamic(prec=prec, c='0.02', j = 16)
...
P = assemble(DD, coarsePartition, basis='Liverani_basis', epsilon=epsilon, prec=prec, n_jobs=1)
last_r=last_row(P)
